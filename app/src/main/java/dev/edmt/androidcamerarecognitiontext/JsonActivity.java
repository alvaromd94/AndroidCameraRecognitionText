...
import dev.edmt.androidcamerarecognitiontext.Model.Matricula;
...
public class JsonActivity extends AppCompatActivity {
    ...
    private String APIserver = "http://localhost/pmdm/";
    ...
    public void clicBuscar(View view) {
        EditText txtidRegistro = (EditText) findViewById(R.id.txtIdRegistro);
